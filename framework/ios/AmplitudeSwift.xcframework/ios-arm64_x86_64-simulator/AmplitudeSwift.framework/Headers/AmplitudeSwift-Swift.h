...
@interface UIView (SWIFT_EXTENSION(AmplitudeSwift))
/// Mark this view to be ignored for specific interaction events
/// \param rageClick Whether to ignore rage click detection for this view
///
/// \param deadClick Whether to ignore dead click detection for this view
///
- (void)amp_ignoreInteractionEventWithRageClick:(BOOL)rageClick deadClick:(BOOL)deadClick;
@end
